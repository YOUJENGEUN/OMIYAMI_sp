  ...
  <body style="background-color: var(--trueGray50)">
    ...
    <main class="signup-wrapper my-5">
     <form action="/findPW" method="post">
      ...
      <div class="form-signin ms-5" style="font-size: 15px">
        <div class="d-flex pb-5" style="margin-left: 150px">
          <div class="col-2 kr-700">아이디</div>
          <div class="w-60">
            <input type="text" class="form-control-id" id="user-id" name="username" />
          </div>
        </div>
        <div class="d-flex pb-5" style="margin-left: 150px">
          <div class="col-2 kr-700">이름</div>
          <div class="w-60">
            <input type="text" class="form-control-id" id="user-name" name="name"/>
          </div>
        </div>
        <div class="d-flex pb-5" style="margin-left: 150px">
      ...
      <div class="text-center mb-5 pb-5">
        <p>
         	 이미 가입하셨나요?
          <a
            href="${pageContext.request.contextPath}/login" class="text-reset mx-2"
