  ...
  <body style="background-color: var(--trueGray50)">
    ...
    <main class="signwel-wrapper">
      <div class="find-text text-center">
        <p class="my-4 kr-900" style="font-size: 40px">아이디 찾기 완료</p>
        <p style="margin-top: 100px">회원님의 아이디는 <span style="font-size: var(--size300); font-weight: 600;">${username}</span>입니다</p>
      </div>
      ...
      <div class="d-flex justify-content-center" style="margin-bottom: 150px">
        ...
        <a href="/findPW">
          <button class="login btn-pro" type="submit">비밀번호 찾기</button>
        </a>
      </div>
    </main>
